...
/*	
	protected Value createValue(Type valueType, String name, ValueArrayList arguments) {
		...
		case action:
			...
			localArguments.add( new Value(Type.longinteger, Value.VALUE_BY_NAME_ACTION_MINTIME, Time.getNowInMillis() ));  
			localArguments.add( new Value(Type.longinteger, Value.VALUE_BY_NAME_ACTION_MAXTIME, Time.getNowInMillis() ));  
			localArguments.add( new Value(Type.integer, Value.VALUE_BY_NAME_ACTION_PRIORITY, 0) );  
			localArguments.add( new Value(Type.integer, Value.VALUE_BY_NAME_ACTION_DURATION, 0L) ); 
...
*/
	protected Value createValue(Type valueType, int subType, String name, ValueArrayList arguments) {
		...
		case action:
			...
			localArguments.add( new Value(Type.longinteger, Value.VALUE_BY_NAME_ACTION_MAXTIME, Time.getNowInMillis() ));  
			localArguments.add( new Value(Type.integer, Value.VALUE_BY_NAME_ACTION_PRIORITY, 0) );  
			localArguments.add( new Value(Type.integer, Value.VALUE_BY_NAME_ACTION_DURATION, 0) ); 
