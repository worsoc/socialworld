    ...
    public double[] getCorners() {
        ...
        switch (type) {
            ...
            case 5: // steigend von Kante West zur Kante Ost
                o = 1.0; s = 1.0; 
                break;
            case 6: // steigend von Ecke SW zur Mitteldiagonale, steigend von Ecke NO zur Mitteldiagonale
                // Die Diagonale von Nord nach Süd bildet den hohen Grat
                n = 1.0; 
                s = 1.0; 
                o = 0.0; 
                w = 0.0; 
                break;            case 7: // steigend von Ecke NW auf die Mitteldiagonale und eben nach SO
                n = 1.0; o = 1.0; s = 1.0; // Nur NW-Ecke (w) bleibt unten
                break;
            case 8: // steigend von Mitteldiagonale in Ecke NordWest
                n = 1.0; 
                break;
            case 9: // steigend von Ecke NW zur Mitteldiagonale, steigend von Ecke SO zur Mitteldiagonale
                // Die Diagonale von West nach Ost bildet den hohen Grat
                w = 1.0; 
                o = 1.0; 
                n = 0.0; 
                s = 0.0; 
                break;            case 10: // steigend von Kante Ost zur Kante West
                n = 1.0; w = 1.0; 
                break;
