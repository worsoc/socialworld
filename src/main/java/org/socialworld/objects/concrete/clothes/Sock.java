...
public abstract class Sock extends HumanCrafted implements IWearable {

	public static int getLexemIdLowerValue() {
		return GroupingOfSimulationObjects.LEXEMID_LOWERVALUE_SOCK;
	}
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	public Sock() {
		super();
		belongsTo = EnumHumanCrafted.Sock;
	}
