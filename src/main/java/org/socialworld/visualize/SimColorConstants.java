...
public class SimColorConstants {
	...
	public static final Color COLOR_LIGHT_YELLOW3 = new Color(255,255,102);
  	...
  	public static Color[] ordererColors;
  	
  	public static Color getColorForOrderNr(int orderNr) {
  		if (ordererColors == null) {
  			ordererColors = new Color[155];
		  	ordererColors[0] = COLOR_BLACK;
		  	ordererColors[1] = COLOR_GAINSBORO;
		  	ordererColors[2] = COLOR_LIGHTGRAY;
		  	ordererColors[3] = COLOR_SILVER;
		  	ordererColors[4] = COLOR_DARKGRAY;
		  	ordererColors[5] = COLOR_GRAY;
		  	ordererColors[6] = COLOR_DIMGRAY;
		  	ordererColors[7] = COLOR_SLATEGRAY;
		  	ordererColors[8] = COLOR_LIGHTSLATEGRAY;
		  	ordererColors[9] = COLOR_LIGHTSKYBLUE;
		  	ordererColors[10] = COLOR_SKYBLUE;
		  	ordererColors[11] = COLOR_DEEPSKYBLUE;
		  	ordererColors[12] = COLOR_DODGERBLUE;
		  	ordererColors[13] = COLOR_STEELBLOW;
		  	ordererColors[14] = COLOR_CORNFLOWERBLUE;
		  	ordererColors[15] = COLOR_ROYELBLUE;
		  	ordererColors[16] = COLOR_BLUE;
		  	ordererColors[17] = COLOR_MEDIUMBLUE;
		  	ordererColors[18] = COLOR_DARKEBLUE;
		  	ordererColors[19] = COLOR_NAVY;
		  	ordererColors[20] = COLOR_MIDNIGHTBLUE;
		  	ordererColors[21] = COLOR_DARKESLATEBLUE;
		  	ordererColors[22] = COLOR_MEDIUMSLATEBLUE;
		  	ordererColors[23] = COLOR_SLATEBLUE;
		  	ordererColors[24] = COLOR_BLUEVIOLET;
		  	ordererColors[25] = COLOR_INDIGO;
		  	ordererColors[26] = COLOR_MAROON;
		  	ordererColors[27] = COLOR_DARKRED;
		  	ordererColors[28] = COLOR_BROWN;
		  	ordererColors[29] = COLOR_FIREBRICK;
		  	ordererColors[30] = COLOR_TOMATO;
		  	ordererColors[31] = COLOR_ORANGERED;
		  	ordererColors[32] = COLOR_DARKORANGE;
		  	ordererColors[33] = COLOR_CORAL;
		  	ordererColors[34] = COLOR_ORANGE;
		  	ordererColors[35] = COLOR_CHOCOLATE;
		  	ordererColors[36] = COLOR_SIENNA;
		  	ordererColors[37] = COLOR_SADDLEBROWN;
		  	ordererColors[38] = COLOR_SADDLSEBROWN;
		  	ordererColors[39] = COLOR_GOLDEN_BROWN;
		  	ordererColors[40] = COLOR_GOLDENROD;
		  	ordererColors[41] = COLOR_METALLIC_GOLD;
		  	ordererColors[42] = COLOR_OLD_GOLD;
		  	ordererColors[43] = COLOR_OLIVE;
		  	ordererColors[44] = COLOR_OLIVEDRAB;
		  	ordererColors[45] = COLOR_DARKOLIVEGREEN;
		  	ordererColors[46] = COLOR_GREEN;
		  	ordererColors[47] = COLOR_DARKGREEN;
		  	ordererColors[48] = COLOR_FORESTGREEN;
		  	ordererColors[49] = COLOR_LIMEGREEN;
		  	ordererColors[50] = COLOR_YELLOWGREEN;
		  	ordererColors[51] = COLOR_CHARTREUSE;
		  	ordererColors[52] = COLOR_LIME;
		  	ordererColors[53] = COLOR_LAWNGREEN;
		  	ordererColors[54] = COLOR_GREENYELLOW;
		  	ordererColors[55] = COLOR_SPRINGGREEN;
		  	ordererColors[56] = COLOR_PALEGREEN;
		  	ordererColors[57] = COLOR_LIGHTGREEN;
		  	ordererColors[58] = COLOR_MEDIUMSPRINGGREEN;
		  	ordererColors[59] = COLOR_MEDIUMSEAGREEN;
		  	ordererColors[60] = COLOR_SEAGREEN;
		  	ordererColors[61] = COLOR_DARKSEAGREEN;
		  	ordererColors[62] = COLOR_MEDIUMAQUAMARINE;
		  	ordererColors[63] = COLOR_TURQUOISE;
		  	ordererColors[64] = COLOR_MEDIUMTURQUOISE;
		  	ordererColors[65] = COLOR_DARKTURQUOISE;
		  	ordererColors[66] = COLOR_CADETBLUE;
		  	ordererColors[67] = COLOR_DARKSLATEGRAY;
		  	ordererColors[68] = COLOR_DARKCYAN;
		  	ordererColors[69] = COLOR_TEAL;
		  	ordererColors[70] = COLOR_LIGHTSEAGREEN;
		  	ordererColors[71] = COLOR_AQUAMARINE;
		  	ordererColors[72] = COLOR_CYAN;
		  	ordererColors[73] = COLOR_PALETURQUOISE;
		  	ordererColors[74] = COLOR_POWDERBLUE;
		  	ordererColors[75] = COLOR_LIGHTSTEELBLUE;
		  	ordererColors[76] = COLOR_LIGHTBLUE;
		  	ordererColors[77] = COLOR_LAVENDER;
		  	ordererColors[78] = COLOR_ROSYBROWN;
		  	ordererColors[79] = COLOR_CRIMSONRGB;
		  	ordererColors[80] = COLOR_HOTPINK;
		  	ordererColors[81] = COLOR_PINK;
		  	ordererColors[82] = COLOR_LIGHTPINK;
		  	ordererColors[83] = COLOR_TAN;
		  	ordererColors[84] = COLOR_WHEAT;
		  	ordererColors[85] = COLOR_PERU;
		  	ordererColors[86] = COLOR_LIGHTCYAN;
		  	ordererColors[87] = COLOR_KHAKI;
		  	ordererColors[88] = COLOR_PALEGOLDENROD;
		  	ordererColors[89] = COLOR_GOLDEN_YELLOW;
		  	ordererColors[90] = COLOR_ALICEBLUE;
		  	ordererColors[91] = COLOR_LIGHTGOLDENRODYELLOW;
		  	ordererColors[92] = COLOR_CORNSILK;
		  	ordererColors[93] = COLOR_BLANCHEDALMOND;
		  	ordererColors[94] = COLOR_VEGAS_GOLD;
		  	ordererColors[95] = COLOR_PALE_GOLD;
		  	ordererColors[96] = COLOR_BISQUE;
		  	ordererColors[97] = COLOR_NAVAJOWHITE;
		  	ordererColors[98] = COLOR_SANDYBROWN;
		  	ordererColors[99] = COLOR_BURLYWOOD;
		  	ordererColors[100] = COLOR_GOLD;
		  	ordererColors[101] = COLOR_DEEPPINK;
		  	ordererColors[102] = COLOR_PALEVIOLETRED;
		  	ordererColors[103] = COLOR_MEDIUMVIOLETRED;
		  	ordererColors[104] = COLOR_AVENDER;
		  	ordererColors[105] = COLOR_THISTLE;
		  	ordererColors[106] = COLOR_PLUM;
		  	ordererColors[107] = COLOR_VIOLET;
		  	ordererColors[108] = COLOR_ORCHID;
		  	ordererColors[109] = COLOR_FUCHSIA;
		  	ordererColors[110] = COLOR_MAGENTA;
		  	ordererColors[111] = COLOR_MEDIUMORCHID;
		  	ordererColors[112] = COLOR_MEDIUMPURPLE;
		  	ordererColors[113] = COLOR_DARKVIOLET;
		  	ordererColors[114] = COLOR_DARKORCHID;
		  	ordererColors[115] = COLOR_DARKMAGENTA;
		  	ordererColors[116] = COLOR_PURPLE;
		  	ordererColors[117] = COLOR_LIGHTSALMON;
		  	ordererColors[118] = COLOR_SALMON;
		  	ordererColors[119] = COLOR_DARKSALMON;
		  	ordererColors[120] = COLOR_LIGHTCORAL;
		  	ordererColors[121] = COLOR_INDIANRED;
		  	ordererColors[122] = COLOR_CRIMSON;
		  	ordererColors[123] = COLOR_RED;
		  	ordererColors[124] = COLOR_WHITE;
		  	ordererColors[125] = COLOR_SNOW;
		  	ordererColors[126] = COLOR_HONEYDEW;
		  	ordererColors[127] = COLOR_MINTCREAM;
		  	ordererColors[128] = COLOR_AZURE;
		  	ordererColors[129] = COLOR_GHOSTWHITE;
		  	ordererColors[130] = COLOR_WHITESMOKE;
		  	ordererColors[131] = COLOR_SEASHELL;
		  	ordererColors[132] = COLOR_BEIGE;
		  	ordererColors[133] = COLOR_OLDLACE;
		  	ordererColors[134] = COLOR_FLORALWHITE;
		  	ordererColors[135] = COLOR_IVORY;
		  	ordererColors[136] = COLOR_ANTIQUEWHITE;
		  	ordererColors[137] = COLOR_LINEN;
		  	ordererColors[138] = COLOR_LAVENDERBLUSH;
		  	ordererColors[139] = COLOR_MISTYROSE;
		  	ordererColors[140] = COLOR_LIGHTYELLOW;
		  	ordererColors[141] = COLOR_LEMONCHIFFON;
		  	ordererColors[142] = COLOR_PAPAYAWHIP;
		  	ordererColors[143] = COLOR_MOCCASIN;
		  	ordererColors[144] = COLOR_PEACHPUFF;
		  	ordererColors[145] = COLOR_DARKKHAKI;
		  	ordererColors[146] = COLOR_YELLOW;
		  	ordererColors[147] = COLOR_LIGHT_YELLOW1;
		  	ordererColors[148] = COLOR_LIGHT_YELLOW2;
		  	ordererColors[149] = COLOR_LIGHT_YELLOW3;
		  	ordererColors[150] = COLOR_LIGHT_YELLOW4;
		  	ordererColors[151] = COLOR_DARK_YELLOW1;
		  	ordererColors[152] = COLOR_DARK_YELLOW2;
		  	ordererColors[153] = COLOR_DARK_YELLOW3;
		  	ordererColors[154] = COLOR_DARK_YELLOW4;
  		}
  		if (orderNr > 0 && orderNr <= 154) {
  			return ordererColors[orderNr];
  		}
  		else {
  			return Color.WHITE;
  		}
