 ...
 */
public class StartSimulationAction implements IWorkbenchWindowActionDelegate {
	
	public static final String ID = "org.socialworld.simpleclient.startSimulation.StartSimulationAction";
